...
class EditPerRepsForm extends StatefulWidget {
  ...
  @override
  _EditPerRepsFormState createState() => _EditPerRepsFormState();
}

class _EditPerRepsFormState extends State<EditPerRepsForm> {

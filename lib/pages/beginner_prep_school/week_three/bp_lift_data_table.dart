...
class BPLiftDataTable extends StatefulWidget {
  const BPLiftDataTable({
    Key key,
    this.lift,
    this.seventyPercent,
    this.eightyPercent,
  ...
  @override
  _BPLiftDataTableState createState() => _BPLiftDataTableState();
}

class _BPLiftDataTableState extends State<BPLiftDataTable> {
  @override
            ...
            rows: [
              DataRow(cells: [
                ...
                DataCell(Padding(
                  ...
                  child: Checkbox(
                      ...
                      value: model.checkboxes[widget.checkIndex0].trueOrFalse ==
                              'false'
                          ? false
                          : true,
              ...
              DataRow(cells: [
                ...
                DataCell(Padding(
                  ...
                  child: Checkbox(
                      checkColor: ThemeData.dark().primaryColorDark,
                      value: model.checkboxes[widget.checkIndex1].trueOrFalse ==
                              'false'
                          ? false
                          : true,
                      onChanged: (bool value) {
              ...
              DataRow(cells: [
                ...
                DataCell(Padding(
                  ...
                  child: Checkbox(
                      checkColor: ThemeData.dark().primaryColorDark,
                      value: model.checkboxes[widget.checkIndex2].trueOrFalse ==
                              'false'
                          ? false
                          : true,
                      onChanged: (bool value) {

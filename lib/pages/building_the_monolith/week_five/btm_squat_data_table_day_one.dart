...
class BTMSquatDataTableDayOne extends StatefulWidget {
  const BTMSquatDataTableDayOne({
    Key key,
    this.lift,
    this.seventyPercent,
    this.eightyPercent,
  ...
  @override
  _BTMSquatDataTableDayOneState createState() =>
      _BTMSquatDataTableDayOneState();
}

class _BTMSquatDataTableDayOneState extends State<BTMSquatDataTableDayOne> {

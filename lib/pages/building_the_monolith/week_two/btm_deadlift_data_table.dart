...
class BTMDeadliftDataTable extends StatefulWidget {
  const BTMDeadliftDataTable({
    Key key,
    this.lift,
    this.seventyPercent,
    this.eightyPercent,
  ...
  @override
  _BTMDeadliftDataTableState createState() => _BTMDeadliftDataTableState();
}

class _BTMDeadliftDataTableState extends State<BTMDeadliftDataTable> {
  @override

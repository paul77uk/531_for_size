...
class BTMSquatDataTableDayThree extends StatefulWidget {
  const BTMSquatDataTableDayThree({
    Key key,
    this.lift,
    this.seventyPercent,
    this.eightyPercent,
    ...
    this.checkIndex8,
    this.checkIndex9,
    this.fortyFivePercent,
    // this.checkIndex10,
  }) : super(key: key);

  final String lift;
  final String fortyPercent;
  final String fortyFivePercent;
  ...
  @override
  _BTMSquatDataTableDayThreeState createState() =>
      _BTMSquatDataTableDayThreeState();
}

class _BTMSquatDataTableDayThreeState extends State<BTMSquatDataTableDayThree> {
  @override
          ...
          DataTable(
            ...
            rows: [
              ...
              DataRow(cells: [
                ...
                DataCell(Padding(
                  padding: const EdgeInsets.only(left: 12.0),
                  child: Text('${widget.fortyFivePercent}'),
                )),
                DataCell(Padding(
                  padding: const EdgeInsets.only(left: 10.0),
                  child: Text('20'),

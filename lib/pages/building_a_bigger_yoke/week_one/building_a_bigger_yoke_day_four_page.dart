...
class _BuildingABiggerYokeDayFourPageState
  ...
  Future<dynamic> getExercisePushIndex() async {
    ...
    setState(() {
      exerciseIndexPush = prefs.getInt('bbyw1d4pushIndex');
    });
  }
  ...
  Future<dynamic> getExercisePushName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePush = prefs.getString('bbyw1d4pushName');
    });
  }
  ...
  Future<dynamic> getExercisePullIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexPull = prefs.getInt('bbyw1d4pullIndex');
    });
  }
  ...
  Future<dynamic> getExercisePullName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePull = prefs.getString('bbyw1d4pullName');
    });
  }
  ...
  Future<dynamic> getExerciseSLCIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexSLC = prefs.getInt('bbyw1d4slcIndex');
    });
  }
  ...
  Future<dynamic> getExerciseSLCName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNameSLC = prefs.getString('bbyw1d4slcName');
    });
  }
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          //     addExerciseIndex: 'bbyw1d4pushIndex',
          //     addExerciseName: 'bbyw1d4pushName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw1d4pullIndex',
          //     addExerciseName: 'bbyw1d4pullName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw1d4slcIndex',
          //     addExerciseName: 'bbyw1d4slcName',
          //   ),
          // ),
          OneSet(

...
class _BuildingABiggerYokeDayTwoPageState
  ...
  Future<dynamic> getExercisePushIndex() async {
    ...
    setState(() {
      exerciseIndexPush = prefs.getInt('bbyw3d2pushIndex');
    });
  }
  ...
  Future<dynamic> getExercisePushName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePush = prefs.getString('bbyw3d2pushName');
    });
  }
  ...
  Future<dynamic> getExercisePullIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexPull = prefs.getInt('bbyw3d2pullIndex');
    });
  }
  ...
  Future<dynamic> getExercisePullName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePull = prefs.getString('bbyw3d2pullName');
    });
  }
  ...
  Future<dynamic> getExerciseSLCIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexSLC = prefs.getInt('bbyw3d2slcIndex');
    });
  }
  ...
  Future<dynamic> getExerciseSLCName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNameSLC = prefs.getString('bbyw3d2slcName');
    });
  }
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          //     addExerciseIndex: 'bbyw3d2pushIndex',
          //     addExerciseName: 'bbyw3d2pushName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw3d2pullIndex',
          //     addExerciseName: 'bbyw3d2pullName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw3d2slcIndex',
          //     addExerciseName: 'bbyw3d2slcName',
          //   ),
          // ),
          OneSet(

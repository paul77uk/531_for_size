...
class _BuildingABiggerYokeDayFourPageState
  ...
  Future<dynamic> getExercisePushIndex() async {
    ...
    setState(() {
      exerciseIndexPush = prefs.getInt('bbyw3d4pushIndex');
    });
  }
  ...
  Future<dynamic> getExercisePushName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePush = prefs.getString('bbyw3d4pushName');
    });
  }
  ...
  Future<dynamic> getExercisePullIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexPull = prefs.getInt('bbyw3d4pullIndex');
    });
  }
  ...
  Future<dynamic> getExercisePullName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePull = prefs.getString('bbyw3d4pullName');
    });
  }
  ...
  Future<dynamic> getExerciseSLCIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexSLC = prefs.getInt('bbyw3d4slcIndex');
    });
  }
  ...
  Future<dynamic> getExerciseSLCName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNameSLC = prefs.getString('bbyw3d4slcName');
    });
  }
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          //     addExerciseIndex: 'bbyw3d4pushIndex',
          //     addExerciseName: 'bbyw3d4pushName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw3d4pullIndex',
          //     addExerciseName: 'bbyw3d4pullName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw3d4slcIndex',
          //     addExerciseName: 'bbyw3d4slcName',
          //   ),
          // ),
          OneSet(

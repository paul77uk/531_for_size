...
class _BuildingABiggerYokeDayOnePageState
  ...
  Future<dynamic> getExercisePushIndex() async {
    ...
    setState(() {
      exerciseIndexPush = prefs.getInt('bbyw3d1pushIndex');
    });
  }
  ...
  Future<dynamic> getExercisePushName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePush = prefs.getString('bbyw3d1pushName');
    });
  }
  ...
  Future<dynamic> getExercisePullIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexPull = prefs.getInt('bbyw3d1pullIndex');
    });
  }
  ...
  Future<dynamic> getExercisePullName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePull = prefs.getString('bbyw3d1pullName');
    });
  }
  ...
  Future<dynamic> getExerciseSLCIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexSLC = prefs.getInt('bbyw3d1slcIndex');
    });
  }
  ...
  Future<dynamic> getExerciseSLCName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNameSLC = prefs.getString('bbyw3d1slcName');
    });
  }
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          //     addExerciseIndex: 'bbyw3d1pushIndex',
          //     addExerciseName: 'bbyw3d1pushName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw3d1pullIndex',
          //     addExerciseName: 'bbyw3d1pullName',
          //   ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //     addExerciseIndex: 'bbyw3d1slcIndex',
          //     addExerciseName: 'bbyw3d1slcName',
          //   ),
          // ),
          OneSet(

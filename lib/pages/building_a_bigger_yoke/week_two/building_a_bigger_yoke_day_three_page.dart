...
class _BuildingABiggerYokeDayThreePageState
  ...
  Future<dynamic> getExercisePushIndex() async {
    ...
    setState(() {
      exerciseIndexPush = prefs.getInt('bbyw2d3pushIndex');
    });
  }
  ...
  Future<dynamic> getExercisePushName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePush = prefs.getString('bbyw2d3pushName');
    });
  }
  ...
  Future<dynamic> getExercisePullIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexPull = prefs.getInt('bbyw2d3pullIndex');
    });
  }
  ...
  Future<dynamic> getExercisePullName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNamePull = prefs.getString('bbyw2d3pullName');
    });
  }
  ...
  Future<dynamic> getExerciseSLCIndex() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseIndexSLC = prefs.getInt('bbyw2d3slcIndex');
    });
  }
  ...
  Future<dynamic> getExerciseSLCName() async {
    final SharedPreferences prefs = await _sPrefs;
    setState(() {
      exerciseNameSLC = prefs.getString('bbyw2d3slcName');
    });
  }
    ...
    return Scaffold(
      body: ListView(
        children: <Widget>[
          ...
          //       addExerciseIndex: 'bbyw2d3pushIndex',
          //       addExerciseName: 'bbyw2d3pushName',
          //       ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //       addExerciseIndex: 'bbyw2d3pullIndex',
          //       addExerciseName: 'bbyw2d3pullName',
          //       ),
          // ),
          OneSet(
          ...
          //   route: ChooseExercise(
          //       addExerciseIndex: 'bbyw2d3slcIndex',
          //       addExerciseName: 'bbyw2d3slcName',
          //       ),
          // ),
          OneSet(
